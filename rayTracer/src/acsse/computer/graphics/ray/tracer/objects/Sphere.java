...
public class Sphere extends Shape{
	...
	public boolean intersect(Intersection intersection) {
		...
		if(t1 > Constants.T_MIN && t1 < intersection.getT()) {
			intersection.setT(t1);
		}else if (t2 > Constants.T_MIN && t2 < intersection.getT()){
	...
	public boolean doesIntersect(Ray ray) {
		...
		if(t1 > Constants.T_MIN && t2 < Constants.T_MAX) {
			return true;
		}

		if (t2 > Constants.T_MIN && t2 < Constants.T_MAX) {
			return true;
		}
		return false;
	}
	...
	public String toString() {
		return "Sphere [center=" + center + ", radius=" + radius + ", colour=" + colour.toString() + "]";
	}
}
